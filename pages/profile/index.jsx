...
const Profile = () => {
  ...
  const getProfileDetails = async () => {
    ...
    try {
      ...
      const authRes = await http_get_request({ endpoint: `/user/v1/getMe` });
      setProfile(authRes?.results)
    } catch (error) {
            ...
            <div className="relative drop-shadow-2">
              {
                profile?.photo_source === null ?
                  ...
                  <Image
                    ...
                    width={160}
                    height={160}
                    src={`/upload/${profile?.photo_source}`}
                    alt="User"
                  />
          ...
          <div className="grid grid-cols-2 gap-10 ">
            ...
            <div className="" >
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                ...
                <div className="flex-grow py-4 text-left">{profile?.mobile_number ? profile?.mobile_number : "-"}</div>
              </div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                <div className="capitalize py-2 w-32 font-medium text-gray-900 whitespace-nowrap dark:text-white">Email</div>
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.email ? profile?.email : "-"}</div>
              </div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                <div className="capitalize py-2 w-32 font-medium text-gray-900 whitespace-nowrap dark:text-white">{profile?.id_type}</div>
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.nid ? profile?.nid : "-"}</div>
              </div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                <div className="capitalize py-2 w-32 font-medium text-gray-900 whitespace-nowrap dark:text-white">DOB</div>
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.dob ? profile?.dob : "-"}</div>
              </div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                <div className="capitalize py-2 w-32 font-medium text-gray-900 whitespace-nowrap dark:text-white">Gender</div>
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.gender ? profile?.gender : "-"}</div>
              </div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                <div className="capitalize py-2 w-32 font-medium text-gray-900 whitespace-nowrap dark:text-white">Join Date</div>
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{moment(profile?.created_at).format('DD MMMM YYYY')}</div>
              </div>
            </div>
            ...
            <div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                ...
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.nationality ? profile?.nationality : "-"}</div>
              </div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                <div className="capitalize py-2 w-32 font-medium text-gray-900 whitespace-nowrap dark:text-white">Country</div>
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.country ? profile?.country.name : "-"}</div>
              </div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                <div className="capitalize py-2 w-32 font-medium text-gray-900 whitespace-nowrap dark:text-white">State</div>
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.state ? profile?.state?.name : "-"}</div>
              </div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                <div className="capitalize py-2 w-32 font-medium text-gray-900 whitespace-nowrap dark:text-white">City</div>
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.city !== null ? profile?.city?.name : "-"}</div>
              </div>
              ...
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                ...
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.zip_code ? profile?.zip_code : "-"}</div>
              </div>
              <div className="w-full px-4 justify-start items-center flex  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:bg-gray-800 border-b border-b-gray border-b-1">
                <div className="capitalize py-2 w-32 font-medium text-gray-900 whitespace-nowrap dark:text-white">Address</div>
                <div className="flex justify-center items-center w-[30px]">:</div>
                <div className="flex-grow py-4 text-left">{profile?.address ? profile?.address : "-"}</div>
              </div>
