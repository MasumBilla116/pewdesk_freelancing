      ...
      <div class="flex items-start gap-2.5">
        ...
        <div class="flex flex-col gap-2.5">
          ...
          <div class="leading-1.5 flex w-full max-w-[320px] flex-col">
            <div class="flex items-start bg-gray-50 dark:bg-gray-700 rounded-xl p-2  bg-stroke dark:bg-[#00000073]">
              <div class="me-2">
          ...
          <span class="text-sm font-normal text-gray-500 dark:text-gray-400 -mt-2">
            Delivered
          </span>
        </div>
      </div>
