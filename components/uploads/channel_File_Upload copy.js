        ...
        <>
            <div className="mb-10">
                {pdfPreviews.map((pdfPreview, index) => {
                    // Check if pdfPreview is a non-empty string
                    ...
                    return (
                        <div key={index} style={pdfContainerStyle}>
                            {fileExt === 'pdf' ? (
                                <FontAwesomeIcon icon={faFilePdf} />
                            ) : (fileExt === 'jpg' || fileExt === 'png' || fileExt === 'jpeg') ? (
                                <FontAwesomeIcon icon={faImage} />
                            ) : null}
                            <p style={pdfNameStyle}>{getFileNameFromUrl(pdfPreview)}</p>
                            <button
                                onClick={() => handleDeleteProfile(index)}
                                className="text-sm text-danger relative"
                            >
                                Delete
                            </button>
                        </div>
